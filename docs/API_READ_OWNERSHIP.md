...
| `GET /api/view/resources` | Backend-owned static resource/view descriptor bundle for list labels, icons, scope, access-review targets, and sidebar grouping. Does not read Kubernetes and is safe for the UI to cache/fallback locally. |
