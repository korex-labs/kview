...
func dashboardDescriptor() DashboardDescriptor {
	return DashboardDescriptor{
		...
		SignalFilterCategories: []DashboardSignalFilterCategoryPolicy{
			...
			{Key: "severity", Label: "Severity", Order: 1, Compact: true},
			{Key: "acknowledgement", Label: "Status", Order: 2, Compact: true},
			{Key: "tag", Label: "Tags", Order: 3, Compact: true},
			{Key: "kind", Label: "Kind", Order: 4},
			{Key: "signal_type", Label: "Signal", Order: 5},
			{Key: "namespace", Label: "Top problem namespaces", Order: 6},
			{Key: "namespace_favourite", Label: "Favourites", Order: 7},
			{Key: "namespace_recent", Label: "Recent", Order: 8},
