...
const resourceAliases: Record<Section, string[]> = {
  ...
  networkpolicies: ["networkpolicies", "networkpolicy", "netpol", "netpols", "np"],
  ...
  resourcequotas: ["resourcequotas", "resourcequota", "quota", "quotas", "rq"],
  limitranges: ["limitranges", "limitrange", "limits", "lr"],
