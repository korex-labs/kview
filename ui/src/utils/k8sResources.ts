...
const defaultDashboardViewPolicy: DashboardViewPolicy = {
  ...
  signalFilterCategories: {
    ...
    severity: { label: "Severity", order: 1, compact: true },
    acknowledgement: { label: "Status", order: 2, compact: true },
    tag: { label: "Tags", order: 3, compact: true },
    kind: { label: "Kind", order: 4, compact: false },
    signal_type: { label: "Signal", order: 5, compact: false },
    namespace: { label: "Top problem namespaces", order: 6, compact: false },
    namespace_favourite: { label: "Favourites", order: 7, compact: false },
    namespace_recent: { label: "Recent", order: 8, compact: false },
