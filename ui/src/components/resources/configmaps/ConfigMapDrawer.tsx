  ...
  return (
    <RightDrawer open={props.open} onClose={props.onClose}>
      <ResourceDrawerShell resourceIcon="configmaps"
        ...
        dynamicLinks={{ resource: "configmaps", namespace: ns, name, labels: details?.metadata?.labels, annotations: details?.metadata?.annotations }}
        ...
        {loading ? (
          ...
          <>
            ...
            <Box sx={drawerBodySx}>
              ...
              {tab === 2 && (
                <Box sx={{ display: "flex", flexDirection: "column", gap: 1, height: "100%", overflow: "auto" }}>
                  <EventsPanel endpoint={`/api/namespaces/${encodeURIComponent(ns)}/configmaps/${encodeURIComponent(name || "")}/events`} token={props.token} emptyMessage="No events found for this ConfigMap." />
                </Box>
              )}
